...
Smith_exp1_RT <- read.csv(paste0(workingdir, "/Smith Data/Smith_exp1_RT.csv"))
  head(Smith_exp1_RT)

Smith_exp2_acc <- read.csv(paste0(workingdir, "/Smith Data/Smith_exp2_acc.csv")) 
  head(Smith_exp2_acc)
  
Smith_exp3_RT <- read.csv(paste0(workingdir, "/Smith Data/Smith_exp3_RT.csv")) 
  head(Smith_exp3_RT)  
